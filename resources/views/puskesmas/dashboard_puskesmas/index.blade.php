...
@section('content')
    @include('puskesmas.layouts_puskesmas.headers.cards')
                ...
                <div class="card bg-gradient-default shadow">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                {{-- <h6 class="text-uppercase text-light ls-1 mb-1">Overview</h6> --}}
                                <h2 class="text-white mb-0">5 Obat Stok Terbanyak </h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="card bg-gradient-default shadow">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                {{-- <h6 class="text-uppercase text-light ls-1 mb-1">Overview</h6> --}}
                                <h2 class="text-white mb-0">5 Obat Pemakaian Terbanyak</h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
var data = {
  ...
  datasets: [{
    label: 'Stok Obat',
    data:  <?php echo json_encode($sisa_obat_masuk); ?>,
    fill: true,
...
var data = {
  ...
  labels:  <?php echo json_encode($nama_obatnya_keluar); ?>,
  datasets: [{
    label: 'Pemakaian Obat',
    data:  <?php echo json_encode($stok_keluar); ?>,
    fill: true,
    backgroundColor: ['rgba(255, 99, 132, 0.2)',
      'rgba(230, 36, 67, 0.9)',
      'rgba(255, 205, 86, 0.2)',
